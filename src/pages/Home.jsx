            ...
            {sales.slice(0, 10).map((sale) => (
              <div key={sale.id} className="bg-white rounded-2xl border border-[#E2E8F0] p-4 flex items-center gap-3 shadow-sm">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[#94A3B8] text-xs font-medium mt-0.5">{sale.paymentMethod} · {sale.time}</p>
                </div>
                <div className="text-right flex-shrink-0">
                  ...
                  {sale.verified ? (
                    <span className="text-[10px] font-semibold px-2.5 py-1 rounded-full bg-green-50 text-green-700">Synced</span>
                  ) : (
